...
barrier_x_start, barrier_x_end = 17.5, 32.5 # 15 x 15 barrier
...
def animate(frames):
    ...
    # add particle positions to density histogram once reached steady state
    if frames >= 3000:
